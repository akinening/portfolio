        ...
        <div class="skill c-shadow">
          ...
          <div class="skill__box">
            ...
            <ul class="description">
              <li>スクラム、アジャイル開発の経験をもとに、プロダクトオーナーを支援します。</li>
              <li>デザイナーとしてデザインプロセスを実施します。</li>
              <li>事業戦略をもとに体験設計を行い、POに提案します。</li>
            </ul>
          </div>
        </div>
        ...
        <div class="skill c-shadow">
          ...
          <div class="skill__box">
            ...
            <ul class="description">
              ...
              <li>0→１の段階から情報設計を行い、UIに落とし込んでいくことが得意です。</li>
              <li>デザインガイドラインやコンポーネントを作成し、開発を効率化します。</li>
            </ul>
          </div>
        </div>
      </div>
