<template>
  <section class="skill mt-80 mb-30">
    ...
    <p class="description">
      ...
      将来的に起こりうる地震・水災・感染症（コロナ等）への対策が10分で策定できます。<br>
      <span class="link">
      ...
      製造業や介護など、素早い復旧が必要な業態に対応する必要がありました。業態ごとに必要な項目が異なっていたり、策定した書類を実際に使用するための要件など、現場を想定しながら画面に落とし込んでいきました。<br>
      質問に回答するだけで以下のようなシートが生成され、そのまま印刷することも可能です。
      <img class="image image--w80" src="@/assets/image/tmnf/bcp_form.png" alt="BCP">
      リリース後、<b>登録企業数が4桁を超える</b>など大きな反響があり、現在も機能改善が進んでいます。
    </p>
  </section>
</template>
