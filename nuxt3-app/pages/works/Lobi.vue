<template>
  <section class="skill mt-80 mb-30">
    <img class="image" :src="ogp" alt="Lobi">
    ...
    <img class="image" :src="lobi_live" alt="生配信のスクリーンショット" loading="lazy">
  </section>
</template>
...
export default {
  ...
  data () {
    return {
      lobi_live: '/assets/image/works/lobi_live.png',
      ogp: '/assets/image/index/lobi.png'
    }
  }
}
</script>
